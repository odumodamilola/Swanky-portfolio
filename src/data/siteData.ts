...
export const blogPosts = [
  {
    id: 1,
    title: "How I designed the Big Brother Naija Reunion set",
    category: "Production Design",
    date: "March 15, 2025",
    readTime: "12 min read",
    excerpt: "From brief to build — the full story of designing Africa's most-watched reunion stage, balancing bold colour, camera angles, and brand identity.",
    image: siteImages.blog.gear,
    featured: true
  },
  {
    id: 2,
    title: "Behind the scenes of \"Hues That Heal\" — my debut solo exhibition",
    category: "Behind the Scenes",
    date: "January 22, 2025",
    readTime: "8 min read",
    excerpt: "From concept sketches to opening night at Victoria Garden City, Lekki — the full story of how faith and colour came together in my most personal show.",
    image: siteImages.blog.behindScenes,
    featured: false
  },
  {
    id: 3,
    title: "Why professionalism matters more than talent in Nollywood",
    category: "Industry Talk",
    date: "December 3, 2024",
    readTime: "15 min read",
    excerpt: "After years on set with top directors, I have learned that discipline, presentation, and leadership shape your career more than raw skill alone.",
    image: siteImages.blog.industryTalk,
    featured: false
  },
  {
    id: 4,
    title: "The art director's toolkit: what I bring to every set",
    category: "Art & Process",
    date: "November 18, 2024",
    readTime: "10 min read",
    excerpt: "From mood boards and colour scripts to power tools and paint — the essentials that have earned permanent spots in my production kit.",
    image: siteImages.blog.lenses,
    featured: false
  },
  {
    id: 5,
    title: "From canvas to set: how fine art training shaped my production design",
    category: "Art & Process",
    date: "October 5, 2024",
    readTime: "14 min read",
    excerpt: "Studying painting at the Polytechnic of Ibadan gave me a foundation that transforms every set I build. Here is how fine art thinking elevates film design.",
    image: siteImages.blog.travel,
    featured: false
  }
];

export const testimonials = [
  { name: "Tunde A.", location: "Lagos, Nigeria", text: "Swanky's masterclass completely changed how I approach set design. His emphasis on professionalism and discipline is exactly what this industry needs.", rating: 5 },
  { name: "Chioma O.", location: "Lagos, Nigeria", text: "Working with Olalekan on set was a masterclass in itself. His attention to detail and ability to build entire worlds from a script is extraordinary.", rating: 5 },
  { name: "Emeka N.", location: "Abuja, Nigeria", text: "We hired Swanky for our broadcast studio design and the result exceeded every expectation. He understands both aesthetics and camera-readiness.", rating: 5 },
  { name: "Bimpe K.", location: "Ibadan, Nigeria", text: "The Chase Media Masterclass was intensive, hands-on, and genuinely inspiring. Olalekan creates an environment where everyone pushes their limits.", rating: 5 },
  { name: "Segun D.", location: "Lagos, Nigeria", text: "As a production designer with years of experience, I thought I had seen it all. Swanky's approach to mood-driven colour direction opened my eyes.", rating: 5 },
  { name: "Aisha M.", location: "Kaduna, Nigeria", text: "The best investment I have made in my creative career. Olalekan does not just teach technique — he teaches vision, discipline, and excellence.", rating: 5 }
];

export const workshopDates = [
  { date: "July 12-13, 2025", location: "Lagos, Nigeria", type: "Production Design Masterclass", spaces: 8 },
  { date: "August 5, 2025", location: "Lagos, Nigeria", type: "KAP Masterclass", spaces: 30 },
  { date: "September 20-21, 2025", location: "Abuja, Nigeria", type: "Set Design Workshop", spaces: 12 },
  { date: "October 10, 2025", location: "Lagos, Nigeria", type: "Chase Media Masterclass", spaces: 25 },
  { date: "November 15-16, 2025", location: "Ibadan, Nigeria", type: "Group Workshop", spaces: 6 },
  { date: "December 3-5, 2025", location: "Lagos, Nigeria", type: "Private Mentorship", spaces: 1 }
];
...
export const pastEvents = [
  ...
  { name: "Gudu Morning Naija Set", location: "NTA Abuja, Nigeria", year: "2019", description: "Designed and built the studio set for NTA Abuja's flagship morning show." }
];
...
export const gearItems = [
  ...
  { name: "Studio & Stage Design", category: "Broadcast", description: "Designing camera-ready studio environments for TV, talk shows, game shows, and podcast productions across Nigeria." },
  { name: "Adobe Creative Suite", category: "Digital Tools", description: "Photoshop, Illustrator, and SketchUp for pre-visualisation, design presentations, and art direction documentation." }
];
